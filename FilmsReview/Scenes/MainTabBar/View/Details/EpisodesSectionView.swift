...
final class EpisodesSectionView: UIView, UITableViewDataSource, UITableViewDelegate {
    ...
    private lazy var seasonButton: UIButton = {
        ...
        button.accessibilityIdentifier = "seasonButton"
        return button
    }()
    ...
    func showSeasonButtonSkeleton() {
        ...
        seasonButtonSkeleton.isHidden = false
        seasonButtonSkeleton.startShimmer()
    }

    func hideSeasonButtonSkeleton() {
        seasonButtonSkeleton.stopShimmer()
        seasonButtonSkeleton.isHidden = true
...
final class EpisodeCell: UITableViewCell {
    ...
    private func updateMoreVisibilityIfNeeded() {
        ...
        let width = max(1, descriptionLabel.bounds.width) // страхуемся от нуля
    ...
    private func makeMoreButton() -> UIButton {
        ...
        b.accessibilityIdentifier = "moreButton"
        return b
    }
}
